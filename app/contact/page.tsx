        ...
        <div className="flex flex-col gap-5">
          ...
          <span className="flex gap-5 align-center">
            <Image
              ...
              height={25}
            />
            <Link href="https://www.instagram.com/deen_ramah/">
              <p>Bet</p>
            </Link>
          </span>
        </div>
        <div className="flex gap-10">
          <Link href="https://www.linkedin.com/in/bett-98-13b28a360/">
            <Image
          ...
          <Link href="https://x.com/Luffy098Taro?s=09">
            <Image
              src="/twitter.png"
              className="hover:scale-110 transition ease-in-out"
              alt="X"
          ...
          <Link href="https://github.com/Yobi98">
            <Image
